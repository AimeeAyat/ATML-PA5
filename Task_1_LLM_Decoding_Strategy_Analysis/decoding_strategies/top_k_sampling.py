"""
Top-K Sampling decoding strategy implementation.
"""
...
class TopKSamplingDecoder:
    """Top-K sampling decoder - samples from top K tokens."""

    def __init__(self, model: PreTrainedModel, tokenizer: PreTrainedTokenizer, top_k: int = 50):
        """
        Initialize top-k sampling decoder.
    ...
    def decode(
        ...
        for _ in range(num_tokens_to_generate):
            ...
            # Top-K filtering: set probabilities outside top-k to 0
            ...
            log_prob = torch.log(filtered_probs.gather(-1, next_token_id))

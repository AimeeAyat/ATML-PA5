...
def load_tensorboard_logs(log_dir="./reward_model_orca_output"):
...
def plot_loss_and_accuracy(metrics, save_path="./reward_model_orca_output"):
...
def plot_reward_statistics(metrics, save_path="./reward_model_orca_output"):
...
def save_metrics_summary(metrics, save_path="./reward_model_orca_output"):
...
def main():
    ...
    parser.add_argument(
        "--log-dir",
        default="./reward_model_orca_output",
